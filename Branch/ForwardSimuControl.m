...
editableCoordSet.get('pro_sup').setValue(osimState, deg2rad(50));
...
editableCoordSet.get('flexion').setValue(osimState, deg2rad(-20));
...
%Controls function
controlsFuncHandle = @OpenSimPlantControlsFunction_control;
Ts=SimuInfo.Ts;
Tend=SimuInfo.Tend;
...
% 
% subplot(2,1,1)
% plot(motionData.data(:,1),(Phi_ref),'go',motionData.data(:,1),(Phi),'r')
% hold on
% 
% subplot(2,1,2)
% plot(motionData.data(:,1),(Psi_ref),'go',motionData.data(:,1),(Psi),'k')
% grid on
% pause(10)
datetime
%clearvars -except J
