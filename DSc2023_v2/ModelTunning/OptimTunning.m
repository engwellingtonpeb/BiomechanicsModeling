...
%Initial Gain Guess
ModelParams=[0 0 0 0 0 0 0.1 0.5 2.5 1.5 0 0 0 0 0 0 0 0 .1];
...
options = optimoptions(@ga,'CrossoverFraction',0.6,'Display','iter',...
    'FunctionTolerance',1e-5,'PopulationSize',100,'MaxGenerations',300,...
    'MutationFcn', {@mutationadaptfeasible,rate},'MaxStallGenerations',15,'OutputFcn',...
    @gaOutputFunc, 'UseParallel', false, 'CreationFcn',{@gacreationnonlinearfeasible},...
