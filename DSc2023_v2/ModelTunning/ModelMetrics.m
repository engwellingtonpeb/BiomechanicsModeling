...
h=hist1.BinCounts;
hold on
hist2=histogram(y1,'BinLimits',edges1,'BinWidth',w,'Normalization','probability');
k=hist2.BinCounts;
...
%% Jensen-Shannon Divergence (link: encr.pw/8gbtV) or https://web.math.ku.dk/~topsoe/ISIT2004JSD.pdf
M=0.5*(h+k);
